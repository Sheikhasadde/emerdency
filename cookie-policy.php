<?php
/**
 * Emerdency-Live - cookie-policy.php
...
<div class="col-md-8 col-md-offset-2" style="background:#2A2930; border-radius:20px;">
    <h1 style="color:white; text-align:center"> Cookie Policy</h1>
		...
		<div class="dashed-list">
                <p><b class="orange-dash">-</b><a class="orange-text"> Account related cookies</a> <br/>
                ...
                <p><b class="orange-dash">-</b><a class="orange-text"> Login related cookies</a> <br/>
                ...
                <p><b class="orange-dash">-</b><a class="orange-text"> Email newsletters related cookies</a><br/>
                ...
                <p><b class="orange-dash">-</b><a class="orange-text"> Orders processing related cookies</a><br/>
				This site offers e-commerce or payment facilities and some cookies are essential to ensure that your order is remembered between pages so that we can process it properly.</p>

                <p><b class="orange-dash">-</b><a class="orange-text"> Site preferences cookies</a><br/>
