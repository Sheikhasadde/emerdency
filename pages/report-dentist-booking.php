<?php
/**
 * Emerdency-Live - report-dentist-booking.php
...
$labels     = getNumOfMonthlyBookingsDentist($dentistId);
$appts      = getDentistAppointmentsByMonth($month,$dentistId);
...
if ( mysqli_num_rows($labels) > 0 ){
	...
	echo "<div class='inner-row'>";
	echo "<h2>No Bookings have been made at this Dentist.</h2>";
	echo "</div>";
}
include( '../footer.php' );
?>