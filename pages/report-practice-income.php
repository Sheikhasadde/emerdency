<?php
/**
 * Emerdency-Live - practice-reports.php
...
?>
	<div class="main-content">
		<h1 class="page-title">Reports - Practice Income</h1>
		<div class="inner-row">
			<input class="btn back" type="button" value="Back" onclick="history.back()">
            <canvas id="incomeChart"></canvas>
		</div>
        <script type="text/javascript">
            var practiceID = <?php echo json_encode($_SESSION["practiceId"]); ?>;
            $(document).ready(function(){
                $.ajax({
                    url: "https://www.emerdency.co.uk/php/reports.php?practiceId="+practiceID,
                    method: "GET",
