		...
		<div class="col-1">
			...
			<div id="hidden_fields">
				<form class="appointment-form" autocomplete="off" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
					...
					First Name:
					<input placeholder="First Name" type="text" name="first_name" readonly value="<? echo $first_name?>" /> </br>
					Last Name:
					<input placeholder="Last Name" type="text" name="last_name" readonly value="<? echo $last_name?>" /> </br>
					House Number/Name:
					...
					Date of Birth:
					<input class="dob" placeholder="YYYY-MM-DD" type="date" name="dob" readonly min="1900-01-01" max="<?php echo $dateMinus16;?>" value="<?php echo $dob?>" /> </br>
					Email Address:
