...
<div class="main-content">
    ...
    <script>
        ...
        scheduler.locale.labels.section_disAccess = "Wheelchair Access";
        scheduler.locale.labels.section_practice = "Practice";
        scheduler.locale.labels.section_telAdvice = "Telephone Advice";
        if (telAdvice == 1) {
            scheduler.config.lightbox.sections=[
                ...
                { name:"disAccess", height: 60, type: "radio", map_to: "disAccess", vertical: true,
                    //options:scheduler.serverList("disAccess")},
                    options: [
                        {key:"1", label:"Yes"},
                        {key:"0", label:"No"}
                    ], default_value: "0"},
                { name:"telAdvice", height: 60, type: "radio", map_to: "telAdvice", vertical: true, options: [
                        {key:"2", label:"Yes"},
                        {key:"0", label:"No"}
                    ], default_value: "0"},
            ...
            scheduler.config.lightbox.sections=[
                { name:"description", height:50, type:"textarea", map_to:"text", focus:true},
                //{ name:"Practice", height:50, type:"text", map_to:"pdId"},
                { name:"Practice", height:50, type:"select", map_to:"pdId", options:practiceOpts},
        ...
        for (var i = 0; i < pdIdArray.length; i++){
            ...
            for (var key in obj){
                ...
                scheduler.load("../php/events2.php?pd="+key);
            }
        }
        var dp = new dataProcessor("../php/events2.php");
        dp.init(scheduler);
    </script>
